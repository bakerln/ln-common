...
/**
 * <p>Description: Date工具包，包装hutool工具
 *        包装Date工具包，后期方便替换</p>
 *
 * @author linan
 * @date 2021-01-11
...
public class DateUtil extends CalendarUtil{
    ...
    public static DateTime parse(CharSequence dateStr, String format, Locale locale) {
        return new DateTime(dateStr, cn.hutool.core.date.DateUtil.newSimpleFormat(format, locale, null));
    }
     ...
     * @param offset    偏移量，正数为向后偏移，负数为向前偏移
     * @return 偏移后的日期
     * @deprecated please use {@link cn.hutool.core.date.DateUtil#offset(Date, DateField, int)}
     */
    @Deprecated
    ...
    public static int toIntSecond(Date date) {
        return Integer.parseInt(cn.hutool.core.date.DateUtil.format(date, "yyMMddHHmm"));
    }
