...
/**
 * <p>Description: NET工具包，包装hutool工具
 *        包装NET工具包，后期方便替换</p>
 *
 * @author linan
 * @date 2021-01-11
...
public class NetUtil {
    ...
    public static boolean isInnerIP(String ipAddress) {
        boolean isInnerIp;
        long ipNum = cn.hutool.core.net.NetUtil.ipv4ToLong(ipAddress);

        long aBegin = cn.hutool.core.net.NetUtil.ipv4ToLong("10.0.0.0");
        long aEnd = cn.hutool.core.net.NetUtil.ipv4ToLong("10.255.255.255");

        long bBegin = cn.hutool.core.net.NetUtil.ipv4ToLong("172.16.0.0");
        long bEnd = cn.hutool.core.net.NetUtil.ipv4ToLong("172.31.255.255");

        long cBegin = cn.hutool.core.net.NetUtil.ipv4ToLong("192.168.0.0");
        long cEnd = cn.hutool.core.net.NetUtil.ipv4ToLong("192.168.255.255");
